...
router.get('/stats', async (req, res) => {
  try {
    ...
    res.json({
      ...
      clanPower:     Math.floor((player.power_level     || 0) * (clanHouseRow?.clan_power     || 0) / 100),
      clanEndurance: Math.floor((player.endurance_level || 0) * (clanHouseRow?.clan_endurance || 0) / 100),
      clanSpeed:     Math.floor((player.speed_level     || 0) * (clanHouseRow?.clan_speed     || 0) / 100),
      clanAccuracy:  Math.floor((player.accuracy_level  || 0) * (clanHouseRow?.clan_accuracy  || 0) / 100),
